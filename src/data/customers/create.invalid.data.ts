...
import { ICreateInvalidDataCustomer } from "types/customer.types";
import { generateCustomerData } from "./generateCustomerData";
import { STATUS_CODES } from "data/statusCodes";
import { faker } from "@faker-js/faker";
import _ from "lodash";

export const regInvalidTestData: ICreateInvalidDataCustomer[] = [
  //Email
  {
    testName: "Error | Email is empty",
    invalidCreationCustomerData: generateCustomerData({ email: "" }),
